...
//var configUrl1 = "https://support.qq.com/products/28096?"
var configUrl1 = "https://docs.qq.com"
...
class WebViewController: BaseViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationResponse: WKNavigationResponse, decisionHandler: @escaping (WKNavigationResponsePolicy) -> Void) {
        ...
        outputText += "0.2. decidePolicyFor navigationResponse.\(url) \n"
        NotificationCenter.default.post(name: Notification.Name(rawValue: notifyKeyOutput), object: self)
        decisionHandler(.allow)
    }
    ...
    override func viewDidLoad() {
        ...
        let myURL = URL(string: configUrl1)
